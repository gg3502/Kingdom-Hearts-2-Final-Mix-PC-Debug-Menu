...
Only the files attached to releases are supported.

To get most out of the debug menu create "DebugMenu" named folder in the same place as game executable and inside add music and CineCam named folders.
